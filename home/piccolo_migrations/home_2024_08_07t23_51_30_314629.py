...
class Scan(Table, tablename="scan", schema=None):
    id = UUID(
        default=UUID4(),
        null=False,
        primary_key=True,
...
async def forwards():
    ...
    manager.add_column(
        table_class_name="Vulnerability",
        tablename="vulnerability",
        column_name="found_by",
        db_column_name="found_by",
        column_class_name="Text",
        column_class=Text,
        params={
            "default": "Unknown",
    ...
    manager.add_column(
        table_class_name="Project",
        tablename="project",
        column_name="is_git_based",
        db_column_name="is_git_based",
